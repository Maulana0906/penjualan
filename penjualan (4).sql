...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2023 at 08:34 AM
...
(2, 'tiyo', '1', '234', 'ideksi'),
(3, 'yoga', '3', '0996934295', 'gresik'),
(4, 'reza', 'l', '06786876', 'prambon'),
(7, 'akabar', 'p', '09090978', 'wonoganteng');
...
(6, 'freya', '567', 'ad'),
(8, 'shg', '444', 'frg'),
(875, 'smgt', '4748', 'prambon'),
(876, 'akabare', '9087797', 'wonoganteng');
...
(22, 1, 3, '2023-11-13', 'buku adalah sebuah benda yang menyimpan segala pengetahuan yang ada didunia');
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `me to` AFTER DELETE ON `transaksi` FOR EACH ROW UPDATE barang
set barang.stok = barang.stok+1
...
--
ALTER TABLE `supplier`
  MODIFY `id_supplier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=877;
